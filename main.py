"""Программа-игра, использует характеристики персонажа.
Позволяет атаковать, защищаться и тренироваться.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Исходя из класса рассчитывает урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Исходя из класса рассчитывает защиту."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Исходя из класса применяет специальное умение."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """В зависимости от класса выводит его описание.
    Позволяет выполнять тренировку персонажа.
    """
    if char_class == 'warrior':
